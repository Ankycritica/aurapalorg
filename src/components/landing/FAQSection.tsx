...
const faqs = [
  ...
  { q: "What AI models power AuraPal?", a: "AuraPal runs on Google Gemini. Each tool uses a purpose-built prompt and a scoring rubric written around what recruiters, hiring managers and ATS filters actually screen for — that structure matters more than the model." },
