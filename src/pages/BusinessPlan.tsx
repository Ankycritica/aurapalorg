  ...
  return (
    <ToolPage
      ...
      fields={[
        ...
        { id: "market", label: "Target Market", placeholder: "e.g. Small businesses, remote workers, students", required: false },
        { id: "budget", label: "Starting Budget", placeholder: "e.g. $5,000", required: false },
      ]}
