...
export default function Auth() {
  ...
  // Unused while the Apple button is hidden — see the note in the markup.
      ...
      <div className="flex-1 flex items-center justify-center p-4 bg-background">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
          ...
          <div className="space-y-3 mb-5">
            ...
            {/* Apple sign-in is hidden until the provider is enabled in Supabase.
                Supabase returns "provider is not enabled" on /authorize, so the
                button was a dead end for every user who clicked it. Enabling it
                needs an Apple Developer account, a Services ID and a signing key.
                To bring it back: enable Apple under Authentication > Providers,
                then restore this block and handleApple below. */}
          </div>
