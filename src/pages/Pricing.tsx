...
const plans = [
  {
    ...
    period: "forever",
    icon: Zap,
    features: ["5 AI generations per day", "All 6 tools", "Basic output formatting", "Copy to clipboard"],
    cta: "Current Plan",
    tier: "free" as const,
    popular: false,
  },
  {
    ...
    period: "/month",
    icon: Crown,
    features: ["100 AI generations per day", "All 6 tools", "Advanced output formatting", "Priority AI processing", "Export to PDF/DOCX"],
    cta: "Upgrade to Pro",
    tier: "pro" as const,
    popular: true,
  },
  {
    ...
    period: "/month",
    icon: Sparkles,
    features: ["Unlimited AI generations", "All 6 tools", "Advanced output formatting", "Priority AI processing", "Export to PDF/DOCX", "Custom branding", "Priority support"],
    cta: "Go Premium",
